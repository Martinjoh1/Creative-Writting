...
import t14_rectangle as rectangle       # notice the different ways we can import, and how that changes how we use it below
from t14_point import Point             # same as above...
import random
import turtle
